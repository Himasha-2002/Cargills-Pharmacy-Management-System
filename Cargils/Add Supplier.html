...
<!--sidebar-->
    <div class="sidebar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                ...
                <a href="Manage Supplier.html">Manage Supplier</a>
            </div>
        </div>
        <div class="dropdown">
            <a href="#"><i class="fa-solid fa-cart-shopping"></i> Purchase<span class="toggle"><</span></a>
            <div class="dropdown-content">
                <a href="..\Cargils\Add Supplier.html">Add Purchase</a>
                <a href="..\Cargils\Manage Supplier.html">Manage Purchase</a>
            </div>
        </div>
        <div class="dropdown">
    ...
    <!--header-->
        <div class="header">  
            <div>
                <h1><i class="fa-solid fa-users"></i>Add Supplier</h1>
        ...
        <div class="form-container">
            <form>
                ...
                <input type="text" id="supplier-email" name="supplier-email" placeholder="Supplier Email">
