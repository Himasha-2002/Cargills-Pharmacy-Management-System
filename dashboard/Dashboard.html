...
<body>
    ...
    <div class="main-content">
        ...
        <section class="overview">
            <div class="card"><b>Total Customer</b></div>
            <div class="card"><b>Total Supplier</b></div>
            <div class="card"><b>Total Medicine</b></div>
            <div class="card"><b>Out Of Stock</b></div>
            <div class="card"><b>Expired</b></div>
            <div class="card"><b>Total Invoice</b></div>
            
          </section>
          <div class="overview2">
            <div class="card"><br>
                <h3><b>Today's Report</b></h3><br><br>
                <p><b>Total Sales: Rs.0</b></p><br><br>
                <p><b>Total Purchase: Rs.0</b></p><br>
              </div>
          </div>
        </div>
        <hr class="styled-hr"></br></br>
          <section class="actions">
            <button class="action-btn"><i class="fa-solid fa-file-invoice"></i><br><br><b>Create New Invoice</b></button>
            <button class="action-btn"><i class="fa-solid fa-users"></i><br><br></b><b>Add New Customer</b></button>
            <button class="action-btn"><i class="fa-solid fa-capsules"></i><br><br><b>Add New Medicine</b></button>
            <button class="action-btn"><i class="fas fa-truck"></i><br><br><b>Add New Supplier</b></button>
            <button class="action-btn"><i class="fa-solid fa-cart-shopping"></i><br><br><b>Add New Purchase</b></button>
            <button class="action-btn"><i class="fas fa-chart-bar"></i><br><br><b>Sales Report</b></button>
            <button class="action-btn"><i class="fas fa-chart-bar"></i><br><br><b>Purchase Report</b></button>
        </section>
        </main>
      </div>
